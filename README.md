...
Research completed at Marymount University in Advanced Computer Security (IT535). Research purpose was to find how to evaluate effective modern authentication with practical attacks. Controlled security research using a dual-dataset methodology: a fixed 100-user static dataset for reproducible results and a 50-user randomized dataset for validation testing. Tests authentication system vulnerabilities under scientific conditions.
